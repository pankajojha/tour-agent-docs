...
- **One Trip Per Coordinator** - Each coordinator may only have one active trip plan at a time; prior plans must be finalized or consumed before a new one is created
